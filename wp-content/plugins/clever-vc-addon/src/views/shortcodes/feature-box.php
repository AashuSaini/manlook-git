...
?>
<div class="zoo-feature-box<?php echo esc_attr($css_class); ?>"<?php echo ent2ncr($box_style); ?>>
            ...
            switch ($atts['style']) {
                ...
                case 'after': ?>
                    ...
                    <?php if (($atts['type'] !== 'text') && (!empty($icon) || !empty($atts['image']))) : ?>
                        <div class="feature-box-media"<?php echo ent2ncr($media_style); ?>>
                            <?php
                            echo wp_kses($zoo_start_link, $zoo_allow_tag);
                            if ($atts['type'] == 'icon') : ?>
                                <i class="circus-box <?php echo esc_attr($icon) ?>"
                                   style="font-size: <?php echo esc_attr($atts['icon_fontsize']); ?>"></i>
                            <?php endif;
                            if ($atts['type'] == 'image') {
                ...
                case 'right': ?>
                    <div class="media">
                        ...
                        <div class="pull-left">
                            <span class="feature-box-media"<?php echo ent2ncr($media_style); ?>>
