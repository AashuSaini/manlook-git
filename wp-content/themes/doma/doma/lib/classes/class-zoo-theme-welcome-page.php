...
if (!class_exists('ZooThemeWelcomePage', false)) {
    ...
    class ZooThemeWelcomePage
    {
        ...
        {
            $label = !empty($this->theme->name) ? $this->theme->name : esc_html__('Welcome', 'doma');
                ...
                <div id="zoo-welcome-panel" class="zoo-welcome-panel">
                    <div class="zoo-welcome-panel-content">
                        <div class="zoo-welcome-heading">
                        	<h1><?php printf(esc_html__( 'Welcome to %s', 'doma' ), $this->theme->name); ?></h1>
                        	<p class="description"><?php printf(esc_html__( 'Thank you for choosing %s.', 'doma'), $this->theme->name); ?></p>
                        </div>
                ...
                <div class="dashboard-widgets-wrap">
                    <div id="dashboard-widgets" class="metabox-holder">
                        <table class="system-status widefat" cellspacing="0">
                        	<thead>
                        		<tr>
                        			<th colspan="3"><?php esc_html_e('System Status', 'doma') ?></th>
                        		</tr>
                        	</thead>
                        	<tbody>
                        		<tr>
