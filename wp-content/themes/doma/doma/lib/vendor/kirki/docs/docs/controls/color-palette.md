...
Kirki::add_field( 'kirki_demo', array(
	...
	'label'       => esc_attr__( 'Color-Palette', 'doma' ),
	'description' => esc_attr__( 'This is a color-palette control', 'doma' ),
...
Kirki::add_field( 'kirki_demo', array(
	...
	'label'       => esc_attr__( 'Color-Palette', 'doma' ),
	'description' => esc_attr__( 'Material Design Colors - all', 'doma' ),
	'section'     => 'color_palette_section',
	'default'     => '#F44336',
	'choices'     => array(
...
Kirki::add_field( 'kirki_demo', array(
	...
	'label'       => esc_attr__( 'Color-Palette', 'doma' ),
	'description' => esc_attr__( 'Material Design Colors - primary', 'doma' ),
	'section'     => 'color_palette_section',
	'default'     => '#000000',
	'choices'     => array(
...
Kirki::add_field( 'kirki_demo', array(
	...
	'label'       => esc_attr__( 'Color-Palette', 'doma' ),
	'description' => esc_attr__( 'Material Design Colors - red', 'doma' ),
	'section'     => 'color_palette_section',
	'default'     => '#FF1744',
	'choices'     => array(
...
Kirki::add_field( 'kirki_demo', array(
	...
	'label'       => esc_attr__( 'Color-Palette', 'doma' ),
	'description' => esc_attr__( 'Material Design Colors - A100', 'doma' ),
	'section'     => 'color_palette_section',
	'default'     => '#FF80AB',
	'choices'     => array(
