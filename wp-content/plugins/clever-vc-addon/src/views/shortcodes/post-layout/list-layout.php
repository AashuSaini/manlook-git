 ...
 * @license     GPL v2
 */
$class = 'zoo-blog-item post-loop-item list-layout-item col-12';
?>
<article <?php echo post_class($class) ?>>
    <div class="zoo-post-inner">
        ...
        the_title(sprintf('<h3 class="entry-title title-post"><a href="%s" rel="' . esc_html__('bookmark', 'zootemplate') . '">', esc_url(get_permalink())), '</a></h3>');?>
        <?php 
