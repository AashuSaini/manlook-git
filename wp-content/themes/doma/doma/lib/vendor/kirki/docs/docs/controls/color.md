...
Kirki::add_field( 'kirki_demo', array(
	...
	'description' => esc_attr__( 'This is a color control - without alpha channel.', 'doma' ),
...
Kirki::add_field( 'kirki_demo', array(
	...
	'label'       => __( 'Color Control (with alpha channel)', 'doma' ),
	'description' => esc_attr__( 'This is a color control - with alpha channel.', 'doma' ),
	'section'     => 'color_section',
	'default'     => '#0088CC',
	'choices'     => array(
		'alpha' => true,
...
Kirki::add_field( 'kirki_demo', array(
	...
	'label'       => __( 'Color Control - hue only.', 'doma' ),
	'description' => esc_attr__( 'This is a color control - hue only.', 'doma' ),
	'section'     => 'color_section',
	'default'     => '#0088CC',
	'mode'        => 'hue',
) );
