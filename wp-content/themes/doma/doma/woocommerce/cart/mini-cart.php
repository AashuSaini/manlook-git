...
?>
<div class="<?php echo esc_attr($wrap_cart_class);  ?>" data-empty-cart="<?php _e('No products in the cart.', 'woocommerce'); ?>">
    <?php do_action('woocommerce_before_mini_cart'); ?>
    <div class="header-cart">
        <h3><?php echo esc_html__('Shopping bag', 'doma'); ?></h3>
                    ...
                    <li class="woocommerce-mini-cart-item  <?php echo esc_attr(apply_filters('woocommerce_mini_cart_item_class', 'mini_cart_item', $cart_item, $cart_item_key)); ?>">
                        ...
                        <div class="right-mini-cart-item">
                            ...
                            echo apply_filters( 'woocommerce_cart_item_remove_link', sprintf(
                                '<a href="%s" class="remove remove_from_cart_button" aria-label="%s" data-product_id="%s" data-cart_item_key="%s" data-product_sku="%s"><i class="cs-font clever-icon-close"></i></a>',
                            ...
                            <?php echo apply_filters( 'woocommerce_widget_cart_item_quantity', '<div class="cart-detail">'.esc_html__('Qty: ','doma').'<span class="quantity">' . sprintf( '%s &times; %s', $cart_item['quantity'], $product_price ) . '</span></div>', $cart_item, $cart_item_key ); ?>
                            </div>
                    </li>
                    <?php
                }
