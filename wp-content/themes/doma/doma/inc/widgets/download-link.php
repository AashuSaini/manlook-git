...
class zoo_theme_download_block_widget extends WP_Widget
{
    ...
    {
        /* Widget settings. */
        $widget_ops = array('classname' => 'zoo_theme_download_block_widget', 'description' => esc_html__('A widget button for download file', 'doma'));

        /* Widget control settings. */
        $control_ops = array('width' => 250, 'height' => 350, 'id_base' => 'zoo_theme_download_block_widget', 'public' => true);

        /* Create the widget. */
        parent::__construct('zoo_theme_download_block_widget', esc_html__('Zoo: Download block', 'doma'), $widget_ops, $control_ops);
    }
    ...
    function widget($args, $instance)
    {
        ...
        $text_link = $instance['text_link'] != '' ? $instance['text_link'] : esc_html__('Download', 'doma');
    ...
    function form($instance)
    {
        ...
        $defaults = array('text_link' => esc_html__('Download', 'doma'), 'link' => '#', 'icon' => 'fa fa-cloud-download');
        $instance = wp_parse_args((array)$instance, $defaults); ?>

        <p>
            <label
                    for="<?php echo esc_attr($this->get_field_id('icon')); ?>"><?php esc_html_e('Class font icon:', 'doma'); ?></label>
        ...
        <p>
            <label
                for="<?php echo esc_attr($this->get_field_id('text_link')); ?>"><?php esc_html(esc_html_e('Text link:', 'doma')); ?></label>
        ...
        <p>
            <label
                for="<?php echo esc_attr($this->get_field_id('link')); ?>"><?php esc_html_e('Link of file:', 'doma'); ?></label>
