			...
			<?php
				...
				foreach ( $grouped_products as $grouped_product ) {
					...
					<tr id="product-<?php the_ID(); ?>" <?php post_class(); ?>>
                        <td class="img">
                            <?php
                            echo $grouped_product->is_visible() ? '<a href="' . esc_url( apply_filters( 'woocommerce_grouped_product_list_link', get_permalink( $grouped_product->get_id() ), $grouped_product->get_id() ) ) . '">' .  get_the_post_thumbnail( $grouped_product->get_id(), 'thumbnail') . '</a>' : $grouped_product->get_name(); ?>
                        </td>
                        <td class="label">
