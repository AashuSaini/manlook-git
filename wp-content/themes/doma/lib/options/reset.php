...
$this->add_field( 'zoo_customizer', array(
	...
	'label'    		=> '',
	'section'  		=> 'reset',
	'default'  		=> '<p>' . esc_html__( 'Click the reset button to reset all options to default values.', 'doma' ) . '</p>',
) );
...
$this->add_field( 'zoo_reset_customizer_button', array(
    ...
    'label'       => '',
	'section'     => 'reset',
    'default'     => sprintf( '<div id="zoo-customize-reset-field"><button name="zoo-customizer-reset" id="zoo-customize-reset-btn" class="button-primary button">%s</button></div>', esc_html__( 'Reset cusomtize options', 'doma' ) ),
) );
