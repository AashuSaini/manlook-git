    ...
    <?php }?>
        ...
        if ($atts['style'] == 'standard') {
            ...
            <div class="cvca-wrap-img">
                ...
                <?php }
                if ($atts['hot_label'] != '') { ?><span
                        class="demobox-label hot-label"><?php echo esc_html__('Hot', 'doma'); ?></span>
                <?php }
                if ($atts['new_label'] != '') { ?><span
                        class="demobox-label new-label"><?php echo esc_html__('New', 'doma'); ?></span>
                <?php }
                echo wp_kses($cvca_start_link, $cvca_allow_tag);
