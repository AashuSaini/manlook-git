...
if ($zoo_main_footer) :
    if (is_active_sidebar('main-footer-1-style-2') || is_active_sidebar('main-footer-2') || is_active_sidebar('main-footer-3') || is_active_sidebar('main-footer-4-style-2')) : ?>
        <div id="main-footer" class="footer-block">
            <div class="container">
                <div class="wrap-main-footer row">
                    <div class="col-xs-12 col-sm-3 main-footer-block">
                        <?php dynamic_sidebar('main-footer-1-style-2'); ?>
                        <div id="copyright">
                    ...
                    <div class="col-xs-12 col-sm-3 main-footer-block">
                        <?php dynamic_sidebar('main-footer-4-style-2'); ?>
                        <?php if($pays): ?>
                        <div class="bottom-footer-block">
                            <h4 class="footer-widget-title text-left"><?php echo esc_html__('PAYMENT METHOD','doma'); ?></h4>
                            <ul class="pay-list">
                            <?php 
                            if($pays):
                                foreach( $pays as $pay ) :
