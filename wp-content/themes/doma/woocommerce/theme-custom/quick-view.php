...
?>
<div class="zoo-quickview-mask"></div>
<div id="zoo-quickview-lb" class="animated fadeIn woocommerce ">
    <div id="product-<?php the_ID();?>" class="wrap-top-single-product product zoo-single-product <?php echo esc_attr($zoo_class); ?>">
        <a href="#" class="close-btn close-quickview" title="<?php esc_attr__('Close','doma')?>"><i class="cs-font clever-icon-close"></i> </a>
