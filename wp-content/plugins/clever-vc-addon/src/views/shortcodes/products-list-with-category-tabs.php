...
$wc_attr = array(
    'post_type' => 'product',
    'product_cat' => $atts['default_category'],
...
$varid = mt_rand();
$css_class = apply_filters(VC_SHORTCODE_CUSTOM_CSS_FILTER_TAG, vc_shortcode_custom_css_class($atts['css'], ' '), 'CleverProductsListCategoryTabs', $atts);
...
<div class="woocommerce product-carousel-shortcode cvca-products-wrap cvca-products-wrap_<?php echo esc_attr($varid); ?> <?php echo esc_attr($css_class) ?>"
    ...
    <div class="cvca-wrapper-products-shortcode row ">
        <?php
        $cvca_wrap_class = "cvca-wrap-products-sc cvca-grid list-style col-12 col-sm-12 col-md-12 col-lg-12";
        ...
        ?>
        <div class="append-class <?php echo esc_attr($cvca_wrap_class) ?> ">
