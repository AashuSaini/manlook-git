 ...
 */
 ...
 function vc_iconpicker_type_cleverfont( $icons )
 {
     $cleverfont_icons = array(
         ...
         array('cs-font clever-icon-refresh-4' => esc_html__('Refresh', 'cvca')),
...
add_filter('vc_iconpicker-type-7_stroke', 'vc_iconpicker_type_pe_7_stroke');
function vc_iconpicker_type_pe_7_stroke( $icons )
{
    $pe_7_stroke_icons = array(
        array('pe-7s-album' => esc_html__('Album', 'cvca')),
        array('pe-7s-arc' => esc_html__('Arc', 'cvca')),
        array('pe-7s-back-2' => esc_html__('Back 2', 'cvca')),
        array('pe-7s-car' => esc_html__('Car', 'cvca')),
        array('pe-7s-diamond' => esc_html__('Diamond', 'cvca')),
        array('pe-7s-door-lock' => esc_html__('Door Lock', 'cvca')),
        array('pe-7s-eyedropper' => esc_html__('Eyedropper', 'cvca')),
        array('pe-7s-female' => esc_html__('Female', 'cvca')),
        array('pe-7s-gym' => esc_html__('Gym', 'cvca')),
        array('pe-7s-hammer' => esc_html__('Hammer', 'cvca')),
        array('pe-7s-headphones' => esc_html__('Headphones', 'cvca')),
        array('pe-7s-helm' => esc_html__('Helm', 'cvca')),
        array('pe-7s-hourglass' => esc_html__('Hourglass', 'cvca')),
        array('pe-7s-leaf' => esc_html__('Leaf', 'cvca')),
        array('pe-7s-magic-wand' => esc_html__('Magic wand', 'cvca')),
        array('pe-7s-male' => esc_html__('Male', 'cvca')),
        array('pe-7s-map-2' => esc_html__('Map 2', 'cvca')),
        array('pe-7s-next-2' => esc_html__('Next 2', 'cvca')),
        array('pe-7s-paint-bucket' => esc_html__('Paint bucket', 'cvca')),
        array('pe-7s-pendrive' => esc_html__('Pendrive', 'cvca')),
        array('pe-7s-photo' => esc_html__('Photo', 'cvca')),
        array('pe-7s-piggy' => esc_html__('Piggy', 'cvca')),
        array('pe-7s-plugin' => esc_html__('Plugin', 'cvca')),
        array('pe-7s-refresh-2' => esc_html__('Refresh 2', 'cvca')),
        array('pe-7s-rocket' => esc_html__('Rocket', 'cvca')),
        array('pe-7s-settings' => esc_html__('Settings', 'cvca')),
        array('pe-7s-shield' => esc_html__('Shield', 'cvca')),
        array('pe-7s-smile' => esc_html__('Smile', 'cvca')),
        array('pe-7s-usb' => esc_html__('Usb', 'cvca')),
        array('pe-7s-vector' => esc_html__('Vector', 'cvca')),
        array('pe-7s-wine' => esc_html__('Wine', 'cvca')),
        array('pe-7s-cloud-upload' => esc_html__('Cloud upload', 'cvca')),
        array('pe-7s-close' => esc_html__('Close', 'cvca')),
        array('pe-7s-bluetooth' => esc_html__('Bluetooth', 'cvca')),
        array('pe-7s-cloud-download' => esc_html__('Cloud download', 'cvca')),
        array('pe-7s-way' => esc_html__('Way', 'cvca')),
        array('pe-7s-close-circle' => esc_html__('Close circle', 'cvca')),
        array('pe-7s-id' => esc_html__('Id', 'cvca')),
        array('pe-7s-angle-up' => esc_html__('Angle up', 'cvca')),
        array('pe-7s-wristwatch' => esc_html__('Wristwatch', 'cvca')),
        array('pe-7s-angle-up-circle' => esc_html__('Angle up circle', 'cvca')),
        array('pe-7s-world' => esc_html__('World', 'cvca')),
        array('pe-7s-angle-right' => esc_html__('Angle right', 'cvca')),
        array('pe-7s-volume' => esc_html__('Volume', 'cvca')),
        array('pe-7s-angle-right-circle' => esc_html__('Angle right circle', 'cvca')),
        array('pe-7s-users' => esc_html__('Users', 'cvca')),
        array('pe-7s-angle-left' => esc_html__('Angle left', 'cvca')),
        array('pe-7s-user-female' => esc_html__('User female', 'cvca')),
        array('pe-7s-angle-left-circle' => esc_html__('Angle left circle', 'cvca')),
        array('pe-7s-up-arrow' => esc_html__('Up arrow', 'cvca')),
        array('pe-7s-angle-down' => esc_html__('Angle down', 'cvca')),
        array('pe-7s-switch' => esc_html__('Switch', 'cvca')),
        array('pe-7s-angle-down-circle' => esc_html__('Angle down circle', 'cvca')),
        array('pe-7s-scissors' => esc_html__('Scissors', 'cvca')),
        array('pe-7s-wallet' => esc_html__('Wallet', 'cvca')),
        array('pe-7s-safe' => esc_html__('Safe', 'cvca')),
        array('pe-7s-volume2' => esc_html__('Volume2', 'cvca')),
        array('pe-7s-volume1' => esc_html__('Volume1', 'cvca')),
        array('pe-7s-voicemail' => esc_html__('Voicemail', 'cvca')),
        array('pe-7s-video' => esc_html__('Video', 'cvca')),
        array('pe-7s-user' => esc_html__('User', 'cvca')),
        array('pe-7s-upload' => esc_html__('Upload', 'cvca')),
        array('pe-7s-unlock' => esc_html__('Unlock', 'cvca')),
        array('pe-7s-umbrella' => esc_html__('Umbrella', 'cvca')),
        array('pe-7s-trash' => esc_html__('Trash', 'cvca')),
        array('pe-7s-tools' => esc_html__('Tools', 'cvca')),
        array('pe-7s-timer' => esc_html__('Timer', 'cvca')),
        array('pe-7s-ticket' => esc_html__('Ticket', 'cvca')),
        array('pe-7s-target' => esc_html__('Target', 'cvca')),
        array('pe-7s-sun' => esc_html__('Sun', 'cvca')),
        array('pe-7s-study' => esc_html__('Study', 'cvca')),
        array('pe-7s-stopwatch' => esc_html__('Stopwatch', 'cvca')),
        array('pe-7s-star' => esc_html__('Star', 'cvca')),
        array('pe-7s-speaker' => esc_html__('Speaker', 'cvca')),
        array('pe-7s-signal' => esc_html__('Signal', 'cvca')),
        array('pe-7s-shuffle' => esc_html__('Shuffle', 'cvca')),
        array('pe-7s-shopbag' => esc_html__('Shopbag', 'cvca')),
        array('pe-7s-share' => esc_html__('Share', 'cvca')),
        array('pe-7s-server' => esc_html__('Server', 'cvca')),
        array('pe-7s-search' => esc_html__('Search', 'cvca')),
        array('pe-7s-film' => esc_html__('Film', 'cvca')),
        array('pe-7s-science' => esc_html__('Science', 'cvca')),
        array('pe-7s-disk' => esc_html__('Disk', 'cvca')),
        array('pe-7s-ribbon' => esc_html__('Ribbon', 'cvca')),
        array('pe-7s-repeat' => esc_html__('Repeat', 'cvca')),
        array('pe-7s-refresh' => esc_html__('Refresh', 'cvca')),
        array('pe-7s-add-user' => esc_html__('Add user', 'cvca')),
        array('pe-7s-refresh-cloud' => esc_html__('Refresh cloud', 'cvca')),
        array('pe-7s-paperclip' => esc_html__('Paperclip', 'cvca')),
        array('pe-7s-radio' => esc_html__('Radio', 'cvca')),
        array('pe-7s-note2' => esc_html__('Note2', 'cvca')),
        array('pe-7s-print' => esc_html__('Print', 'cvca')),
        array('pe-7s-network' => esc_html__('Network', 'cvca')),
        array('pe-7s-prev' => esc_html__('Prev', 'cvca')),
        array('pe-7s-mute' => esc_html__('Mute', 'cvca')),
        array('pe-7s-power' => esc_html__('Power', 'cvca')),
        array('pe-7s-medal' => esc_html__('Medal', 'cvca')),
        array('pe-7s-portfolio' => esc_html__('Portfolio', 'cvca')),
        array('pe-7s-like2' => esc_html__('Like2', 'cvca')),
        array('pe-7s-plus' => esc_html__('Plus', 'cvca')),
        array('pe-7s-left-arrow' => esc_html__('Left arrow', 'cvca')),
        array('pe-7s-play' => esc_html__('Play', 'cvca')),
        array('pe-7s-key' => esc_html__('Key', 'cvca')),
        array('pe-7s-plane' => esc_html__('Plane', 'cvca')),
        array('pe-7s-joy' => esc_html__('Joy', 'cvca')),
        array('pe-7s-photo-gallery' => esc_html__('Photo gallery', 'cvca')),
        array('pe-7s-pin' => esc_html__('Pin', 'cvca')),
        array('pe-7s-phone' => esc_html__('Phone', 'cvca')),
        array('pe-7s-plug' => esc_html__('Plug', 'cvca')),
        array('pe-7s-pen' => esc_html__('Pen', 'cvca')),
        array('pe-7s-right-arrow' => esc_html__('Right arrow', 'cvca')),
        array('pe-7s-paper-plane' => esc_html__('Paper plane', 'cvca')),
        array('pe-7s-delete-user' => esc_html__('Delete user', 'cvca')),
        array('pe-7s-paint' => esc_html__('Paint', 'cvca')),
        array('pe-7s-bottom-arrow' => esc_html__('Bottom arrow', 'cvca')),
        array('pe-7s-notebook' => esc_html__('Notebook', 'cvca')),
        array('pe-7s-note' => esc_html__('Note', 'cvca')),
        array('pe-7s-next' => esc_html__('Next', 'cvca')),
        array('pe-7s-news-paper' => esc_html__('News paper', 'cvca')),
        array('pe-7s-musiclist' => esc_html__('Music list', 'cvca')),
        array('pe-7s-music' => esc_html__('Music', 'cvca')),
        array('pe-7s-mouse' => esc_html__('Mouse', 'cvca')),
        array('pe-7s-more' => esc_html__('More', 'cvca')),
        array('pe-7s-moon' => esc_html__('Moon', 'cvca')),
        array('pe-7s-monitor' => esc_html__('Monitor', 'cvca')),
        array('pe-7s-micro' => esc_html__('Micro', 'cvca')),
        array('pe-7s-menu' => esc_html__('Menu', 'cvca')),
        array('pe-7s-map' => esc_html__('Map', 'cvca')),
        array('pe-7s-map-marker' => esc_html__('Map marker', 'cvca')),
        array('pe-7s-mail' => esc_html__('Mail', 'cvca')),
        array('pe-7s-mail-open' => esc_html__('Mail open', 'cvca')),
        array('pe-7s-mail-open-file' => esc_html__('Mail open file', 'cvca')),
        array('pe-7s-magnet' => esc_html__('Magnet', 'cvca')),
        array('pe-7s-loop' => esc_html__('Loop', 'cvca')),
        array('pe-7s-look' => esc_html__('Look', 'cvca')),
        array('pe-7s-lock' => esc_html__('Lock', 'cvca')),
        array('pe-7s-lintern' => esc_html__('Lintern', 'cvca')),
        array('pe-7s-link' => esc_html__('Link', 'cvca')),
        array('pe-7s-like' => esc_html__('Like', 'cvca')),
        array('pe-7s-light' => esc_html__('Light', 'cvca')),
        array('pe-7s-less' => esc_html__('Less', 'cvca')),
        array('pe-7s-keypad' => esc_html__('Keypad', 'cvca')),
        array('pe-7s-junk' => esc_html__('Junk', 'cvca')),
        array('pe-7s-info' => esc_html__('Info', 'cvca')),
        array('pe-7s-home' => esc_html__('Home', 'cvca')),
        array('pe-7s-home' => esc_html__('Home', 'cvca')),
        array('pe-7s-help2' => esc_html__('Help2', 'cvca')),
        array('pe-7s-help1' => esc_html__('Help1', 'cvca')),
        array('pe-7s-graph3' => esc_html__('Graph 3', 'cvca')),
        array('pe-7s-graph2' => esc_html__('Graph 2', 'cvca')),
        array('pe-7s-graph1' => esc_html__('Graph 1', 'cvca')),
        array('pe-7s-graph' => esc_html__('Graph', 'cvca')),
        array('pe-7s-global' => esc_html__('Global', 'cvca')),
        array('pe-7s-gleam' => esc_html__('Gleam', 'cvca')),
        array('pe-7s-glasses' => esc_html__('Glasses', 'cvca')),
        array('pe-7s-gift' => esc_html__('Gift', 'cvca')),
        array('pe-7s-folder' => esc_html__('Folder', 'cvca')),
        array('pe-7s-flag' => esc_html__('Flag', 'cvca')),
        array('pe-7s-filter' => esc_html__('Filter', 'cvca')),
        array('pe-7s-file' => esc_html__('File', 'cvca')),
        array('pe-7s-expand1' => esc_html__('Expand 1', 'cvca')),
        array('pe-7s-exapnd2' => esc_html__('Expand 2', 'cvca')),
        array('pe-7s-edit' => esc_html__('Edit', 'cvca')),
        array('pe-7s-drop' => esc_html__('Drop', 'cvca')),
        array('pe-7s-drawer' => esc_html__('Drawer', 'cvca')),
        array('pe-7s-download' => esc_html__('Download', 'cvca')),
        array('pe-7s-display2' => esc_html__('Display 2', 'cvca')),
        array('pe-7s-display1' => esc_html__('Display 1', 'cvca')),
        array('pe-7s-diskette' => esc_html__('Diskette', 'cvca')),
        array('pe-7s-date' => esc_html__('Date', 'cvca')),
        array('pe-7s-cup' => esc_html__('Cup', 'cvca')),
        array('pe-7s-culture' => esc_html__('Culture', 'cvca')),
        array('pe-7s-crop' => esc_html__('Crop', 'cvca')),
        array('pe-7s-credit' => esc_html__('Credit', 'cvca')),
        array('pe-7s-copy-file' => esc_html__('Copy file', 'cvca')),
        array('pe-7s-config' => esc_html__('Config', 'cvca')),
        array('pe-7s-compass' => esc_html__('Compass', 'cvca')),
        array('pe-7s-comment' => esc_html__('Comment', 'cvca')),
        array('pe-7s-coffee' => esc_html__('Coffee', 'cvca')),
        array('pe-7s-cloud' => esc_html__('Cloud', 'cvca')),
        array('pe-7s-clock' => esc_html__('Clock', 'cvca')),
        array('pe-7s-check' => esc_html__('Check', 'cvca')),
        array('pe-7s-chat' => esc_html__('Chat', 'cvca')),
        array('pe-7s-cart' => esc_html__('Cart', 'cvca')),
        array('pe-7s-camera' => esc_html__('Camera', 'cvca')),
        array('pe-7s-call' => esc_html__('Call', 'cvca')),
        array('pe-7s-calculator' => esc_html__('Calculator', 'cvca')),
        array('pe-7s-browser' => esc_html__('Browser', 'cvca')),
        array('pe-7s-box2' => esc_html__('Box 2', 'cvca')),
        array('pe-7s-box1' => esc_html__('Box 1', 'cvca')),
        array('pe-7s-bookmarks' => esc_html__('Bookmarks', 'cvca')),
        array('pe-7s-bicycle' => esc_html__('Bicycle', 'cvca')),
        array('pe-7s-bell' => esc_html__('Bell', 'cvca')),
        array('pe-7s-battery' => esc_html__('Battery', 'cvca')),
        array('pe-7s-ball' => esc_html__('Ball', 'cvca')),
        array('pe-7s-back' => esc_html__('Back', 'cvca')),
        array('pe-7s-attention' => esc_html__('Attention', 'cvca')),
        array('pe-7s-anchor' => esc_html__('Anchor', 'cvca')),
        array('pe-7s-albums' => esc_html__('Albums', 'cvca')),
        array('pe-7s-alarm' => esc_html__('Alarm', 'cvca')),
        array('pe-7s-airplay' => esc_html__('Airplay', 'cvca')),
    );

    return array_merge( $icons, $pe_7_stroke_icons);
}
/**
...
function cvca_get_post_size_image(){
   $sizes =  array(
      array('label' => esc_html__('Thumbnail','cvca'),'value' => 'thumbnail' ),
      array('label' => esc_html__('Medium','cvca'),'value' => 'medium' ),
      array('label' => esc_html__('Medium Large','cvca'),'value' => 'medium_large' ),
      array('label' => esc_html__('Large','cvca'),'value' => 'large' ),
      array('label' => esc_html__('Full','cvca'),'value' => 'full' ),
   );
   return $sizes;
...
if(!function_exists('get_custom_posttype_categories_parent_for_vc')){
    function get_custom_posttype_categories_parent_for_vc($post_type){
        $data = array();
        $tax_slug = $post_type;
        $query = new WP_Term_Query(array(
            'hide_empty' => true,
