...
final class Kirki_Fonts {
	...
	public static function get_all_variants() {
		return array(
			'100'       => esc_attr__( 'Ultra-Light 100', 'doma' ),
			'100light'  => esc_attr__( 'Ultra-Light 100', 'doma' ),
			'100italic' => esc_attr__( 'Ultra-Light 100 Italic', 'doma' ),
			'200'       => esc_attr__( 'Light 200', 'doma' ),
			'200italic' => esc_attr__( 'Light 200 Italic', 'doma' ),
			'300'       => esc_attr__( 'Book 300', 'doma' ),
			'300italic' => esc_attr__( 'Book 300 Italic', 'doma' ),
			'400'       => esc_attr__( 'Normal 400', 'doma' ),
			'regular'   => esc_attr__( 'Normal 400', 'doma' ),
			'italic'    => esc_attr__( 'Normal 400 Italic', 'doma' ),
			'500'       => esc_attr__( 'Medium 500', 'doma' ),
			'500italic' => esc_attr__( 'Medium 500 Italic', 'doma' ),
			'600'       => esc_attr__( 'Semi-Bold 600', 'doma' ),
			'600bold'   => esc_attr__( 'Semi-Bold 600', 'doma' ),
			'600italic' => esc_attr__( 'Semi-Bold 600 Italic', 'doma' ),
			'700'       => esc_attr__( 'Bold 700', 'doma' ),
			'700italic' => esc_attr__( 'Bold 700 Italic', 'doma' ),
			'800'       => esc_attr__( 'Extra-Bold 800', 'doma' ),
			'800bold'   => esc_attr__( 'Extra-Bold 800', 'doma' ),
			'800italic' => esc_attr__( 'Extra-Bold 800 Italic', 'doma' ),
			'900'       => esc_attr__( 'Ultra-Bold 900', 'doma' ),
			'900bold'   => esc_attr__( 'Ultra-Bold 900', 'doma' ),
			'900italic' => esc_attr__( 'Ultra-Bold 900 Italic', 'doma' ),
		);
	}
