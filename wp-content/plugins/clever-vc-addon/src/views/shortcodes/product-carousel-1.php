<?php
/**
 * Clever Product Carousel 1 Shortcode
 */
...
$varid = mt_rand();
$css_class = apply_filters(VC_SHORTCODE_CUSTOM_CSS_FILTER_TAG, vc_shortcode_custom_css_class($atts['css'], ' '), 'CleverProductCarousel1', $atts);
...
if ( !empty( $atts['link'] ) ) {
    ...
    $zoo_link_text = ( $zoo_link['title'] != '' ) ? $zoo_link['title'].'<i class="cs-font clever-icon-arrow-right-1" style="font-size: 12px; margin-left: 15px;"></i>' : '';
