...
if (!class_exists('ZooIconField')) {
    class ZooIconField extends WP_Widget
    {
        ...
        {
            $widget_ops = array('classname' => 'ZooIconField', 'description' => esc_html__('Displays Text with Font icons.', 'doma'));

            parent::__construct(false, esc_html__('Zoo: Icon Field', 'doma'), $widget_ops);
        }
        ...
        function form($instance)
        {
            ...
            <p>
                <label
                        for="<?php echo esc_attr($this->get_field_id('icon')); ?>"><?php echo esc_html__('Class Font Icon:','doma'); ?></label>
                ...
                <?php echo esc_html__('Push class font of font icon','doma')?>
            </p>
            <p>
                <label
                        for="<?php echo esc_attr($this->get_field_id('text')); ?>"><?php echo esc_html__('Text content:','doma'); ?></label>
