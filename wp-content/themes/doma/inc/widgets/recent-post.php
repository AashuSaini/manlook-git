...
class zoo_posts_widget extends WP_Widget {
    ...
    function __construct() {
        /* Widget settings. */
        $widget_ops = array( 'classname' => 'zoo_posts_widget', 'description' => esc_html__('A widget that displays posts', 'doma') );

        /* Widget control settings. */
        $control_ops = array( 'width' => 250, 'height' => 350, 'id_base' => 'zoo_posts_widget' );

        /* Create the widget. */
        parent::__construct( 'zoo_posts_widget', esc_html__('Zoo: Posts for Sidebar', 'doma'), $widget_ops, $control_ops );
    }
    ...
    function form( $instance ) {
        ...
        $defaults = array( 'title' => esc_html__('Posts Widget', 'doma'), 'number' => 5, 'categories' => '', 'orderby' => 'date', 'order' => 'DESC','show_img'=>'');
        ...
        <!-- Category -->
        <p>
            <label for="<?php echo esc_attr($this->get_field_id('categories')); ?>"><?php echo esc_html(__('Filter by Category:', 'doma')); ?></label>
            <select id="<?php echo esc_attr($this->get_field_id('categories')); ?>" name="<?php echo esc_attr($this->get_field_name('categories')); ?>" class="widefat categories" style="width:100%;">
                <option value='all' <?php if ('all' == $instance['categories']) echo 'selected="selected"'; ?>><?php echo esc_html(__('All categories', 'doma')); ?></option>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id('orderby')); ?>"><?php echo esc_html(__('Order by:', 'doma')); ?></label>
            <select id="<?php echo esc_attr($this->get_field_id('orderby')); ?>" name="<?php echo esc_attr($this->get_field_name('orderby')); ?>" class="widefat orderby" style="width:100%;">
                <option value='date' <?php if ('date' == $instance['orderby']) echo 'selected="selected"'; ?>><?php echo esc_html(__('Date', 'doma')); ?></option>
                <option value='date' <?php if ('author' == $instance['orderby']) echo 'selected="selected"'; ?>><?php echo esc_html(__('Author', 'doma')); ?></option>
                <option value='date' <?php if ('title' == $instance['orderby']) echo 'selected="selected"'; ?>><?php echo esc_html__('Title', 'doma'); ?></option>
                <option value='date' <?php if ('name' == $instance['orderby']) echo 'selected="selected"'; ?>><?php echo esc_html__('Name', 'doma'); ?></option>
                <option value='date' <?php if ('comment_count' == $instance['orderby']) echo 'selected="selected"'; ?>><?php echo esc_html__('Comment Count', 'doma'); ?></option>
                <option value='date' <?php if ('rand' == $instance['orderby']) echo 'selected="selected"'; ?>><?php echo esc_html__('Random', 'doma'); ?></option>
            </select>
        </p>        <p>
            <label for="<?php echo esc_attr($this->get_field_id('order')); ?>"><?php echo esc_html(__('Order:', 'doma')); ?></label>
            <select id="<?php echo esc_attr($this->get_field_id('order')); ?>" name="<?php echo esc_attr($this->get_field_name('order')); ?>" class="widefat orderby" style="width:100%;">
                <option value='date' <?php if ('DESC' == $instance['order']) echo 'selected="selected"'; ?>><?php echo esc_html(__('DESC', 'doma')); ?></option>
                <option value='date' <?php if ('ASC' == $instance['order']) echo 'selected="selected"'; ?>><?php echo esc_html(__('ASC', 'doma')); ?></option>
             </select>
        </p>
        <!-- Number of posts -->
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'number' )); ?>"><?php esc_html_e('Number of posts to show:', 'doma'); ?></label>
            ...
            <label for="<?php echo esc_attr($this->get_field_id( 'show_img' )); ?>"><?php esc_html_e('Show post thumbnail:', 'doma'); ?></label>
